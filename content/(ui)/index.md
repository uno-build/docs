...
- [Public exports](./public-api.md) — exact exports for every package subpath
- [Current limitations](./limitations.md) — renderer and adapter behavior that differs from the web platform
