...
requestAnimationFrame(function render(time) {
  ...
  ui.draw() // Equivalent to ui.draw({ load_op: 'load' })
...
Apply the layout and viewport setup to each UI. Set `renderer.autoClearColor = false`, then use this order inside the render loop:
