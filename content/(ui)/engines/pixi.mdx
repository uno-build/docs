...
Call `resources.present()` after the last draw of each frame, as in the demo. It presents the completed frame on contexts that require explicit presentation.
