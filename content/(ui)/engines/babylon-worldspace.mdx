...
Disposing the default mesh removes it from the scene and releases its geometry when no other mesh uses it. The separate calls release the material and texture.
