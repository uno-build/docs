...
The WebGPU renderer uses MTSDF alpha distance for strokes and shadows and the RGB distance field for the glyph fill. See [Current limitations](../temp/limitations.mdx) for renderer differences.
